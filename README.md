...
```bash
git clone https://github.com/chaitanyajain18/portofolio.git
cd portofolio
````
...
[🔗 Lihat versi live](https://chaitanyajain18.github.io/portfolio/), [🔗 Lihat versi live](http://localhost:5173/portofolio/)
